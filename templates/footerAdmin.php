...
<section id="pre-footer" class="py-5" style="background-color: #202124;">
    <div class="container-map" style="width: 100%; padding: 10px 20px 50px 20px">
            ...
            <div class="col-lg-3">
                <div class="social-media text-light d-sm-flex flex-sm-column align-items-center">
                    ...
                    <div class="d-flex justify-content-start gap-3">
                        ...
                        <a target="_blank" href="https://www.instagrtiam.com/caps_palmira/"><img src="../../assets/images/metaforas/social_media-instagram.svg" alt="logo instagram"></a>
